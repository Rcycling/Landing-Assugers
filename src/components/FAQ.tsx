          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-4 text-left flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-[#43A047] focus:ring-offset-2 rounded-lg"
              >
